...
import static com.ktar5.slime.misc.CustomTmxMapWriter.Format.*;
import static net.dermetfan.gdx.maps.MapUtils.getProperty;

public class CustomTmxMapWriter extends XmlWriter {

    public static enum Format {
        XML, CSV, Base64, Base64Zlib, Base64Gzip
    }

    /** The height of a layer <strong>IN PIXELS</strong>, to invert the y-axis. {@link #setLayerHeight(int) Set} this explicitly if you want to write something that does not know the layer size, like a {@link #tmx(MapLayer) single} or {@link #tmx(MapLayers, CustomTmxMapWriter.Format) multiple} layers or {@link #tmx(MapObject) object}{@link #tmx(MapObjects) s}. */
    private int layerHeight;

    /** creates a new {@link CustomTmxMapWriter} using the given {@link Writer} */
    public CustomTmxMapWriter(Writer writer) {
        super(writer);
    }

    /** @param map the {@link Map} to write in TMX format
     *  @param format the {@link CustomTmxMapWriter.Format} to use
     *  @return this {@link CustomTmxMapWriter} */
    public CustomTmxMapWriter tmx(Map map, CustomTmxMapWriter.Format format) throws IOException {
     ...
     *  @return this {@link CustomTmxMapWriter} */
    public CustomTmxMapWriter tmx(MapProperties properties) throws IOException {
     ...
     *  @return this {@link CustomTmxMapWriter} */
    public CustomTmxMapWriter tmx(MapProperties properties, Array<String> exclude) throws IOException {
     ...
     *  @return this {@link CustomTmxMapWriter} */
    public CustomTmxMapWriter tmx(TiledMapTileSets sets) throws IOException {
     ...
     *  @return this {@link CustomTmxMapWriter} */
    public CustomTmxMapWriter tmx(TiledMapTileSet set) throws IOException {
     ...
     *  @param format the {@link CustomTmxMapWriter.Format} to use
     *  @return this {@link CustomTmxMapWriter} */
    public CustomTmxMapWriter tmx(MapLayers layers, CustomTmxMapWriter.Format format) throws IOException {
     ...
     *  @return this {@link CustomTmxMapWriter} */
    public CustomTmxMapWriter tmx(MapLayer layer) throws IOException {
        element("objectgroup");
     ...
     *  @param format the {@link CustomTmxMapWriter.Format} to use
     *  @return this {@link CustomTmxMapWriter} */
    public CustomTmxMapWriter tmx(TiledMapTileLayer layer, CustomTmxMapWriter.Format format) throws IOException {
        element("layer");
        attribute("name", layer.getName());
     ...
     *  @return this {@link CustomTmxMapWriter} */
    public CustomTmxMapWriter tmx(MapObjects objects) throws IOException {
     ...
     *  @return this {@link CustomTmxMapWriter} */
    public CustomTmxMapWriter tmx(MapObject object) throws IOException {
