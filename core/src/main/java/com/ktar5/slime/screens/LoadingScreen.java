...
public class LoadingScreen extends AbstractScreen {
    ...
    public void show() {
        ...
        SlimeGame.getGame().getManager().load("data/loading.pack", TextureAtlas.class);
        // Wait until they are finished loading
        SlimeGame.getGame().getManager().finishLoading();
        ...
        TextureAtlas atlas = SlimeGame.getGame().getManager().get("data/loading.pack", TextureAtlas.class);
    ...
    public void render(float delta) {
        ...
        Logger.debug("Updating load.. " + SlimeGame.getGame().getManager().getProgress() + "%");
        if (SlimeGame.getGame().getManager().update()) { // Load some, will return true if done loading
            Logger.debug("Finished loading all assets!");
            EngineManager.get().getGame().setScreen(new GameScreen());
        }

        // Interpolate the percentage to make it more smooth
        percent = Interpolation.linear.apply(percent, SlimeGame.getGame().getManager().getProgress(), 0.1f);
    ...
    public void hide() {
        ...
        SlimeGame.getGame().getManager().unload("data/loading.pack");
