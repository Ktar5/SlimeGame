 ...
 * @see SplitPane
 */
public class CustomSplitPane extends WidgetGroup {
     ...
     */
    public CustomSplitPane (Actor firstWidget, Actor secondWidget, boolean vertical) {
     ...
     * @param secondWidget May be null.
     */
    public CustomSplitPane (Actor firstWidget, Actor secondWidget, boolean vertical, String styleName) {
     ...
     * @param secondWidget May be null.
     */
    public CustomSplitPane (Actor firstWidget, Actor secondWidget, boolean vertical, VisSplitPane.VisSplitPaneStyle style) {
    ...
    public void layout () {
        ...
        if (firstWidget != null) {
//START CUSTOM
            if(firstWidget instanceof CustomSplitPane){
                CustomSplitPane leftPane = (CustomSplitPane) firstWidget;
                float initialValue = 0;
                if(!vertical){
                    initialValue = leftPane.getSplit() * leftPane.getWidth();
                }else{
                    initialValue = leftPane.getSplit() * leftPane.getHeight();
                }
                ...
                if(!vertical){
                    leftPane.setSplitAmount(initialValue / leftPane.getWidth());
                }else{
                    leftPane.setSplitAmount(initialValue / leftPane.getHeight());
                }
            }
//END CUSTOM
